...
class c_config {
public:
    std::unordered_map<std::string, bool> b;//bool
    std::unordered_map<std::string, int> i;//int
    std::unordered_map<std::string, float> f;//float
    std::unordered_map<std::string, float[4]> c;//color
    std::unordered_map<std::string, std::string> s;//string
